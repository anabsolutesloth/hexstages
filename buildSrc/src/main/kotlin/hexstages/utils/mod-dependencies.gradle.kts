...
abstract class HexstagesModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexstagesModDependenciesExtension>("hexstagesModDependencies")

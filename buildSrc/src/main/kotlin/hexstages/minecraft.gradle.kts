...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexstages.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexstages-common-common-refmap.json
        // fixed:   hexstages-common.refmap.json

...
loom {
    forge {
        ...
        mixinConfig(
            "hexstages-common.mixins.json",
            "hexstages-forge.mixins.json",
        )
    }
    ...
    runs {
        register("commonDatagen") {
            ...
            property("hexstages.apply-datagen-mixin", "true")
        }
    }
}

hexstagesModDependencies {
...
dependencies {
    ...
    modImplementation(libs.gamestages)
    compileOnly(libs.bookshelf.common)
    modImplementation(libs.bookshelf.forge)
